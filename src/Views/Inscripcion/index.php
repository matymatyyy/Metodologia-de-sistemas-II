      ...
      <div class="hero-container">
        <div class="hero-content">
          ...
          <p class="hero-description">
            A continuación te presentamos el formulario para la inscripción a las carreras universitarias 2026. 
            El presente formulario implica confirmación de inscripción en el ciclo introductorio, una vez que presione 
            el botón Enviar al finalizar la carga.<br><br>
            Todas las carreras se dictan de forma presencial y de manera completa en la sede de la UTN-FRSN Aula Chacabuco.
            <br><br>
            A partir del envío de la inscripción la comunicación será a través de correo electrónico y WhatsApp. 
            Esté atento a ambos medios de comunicación, incluso correo Spam.
          </p>
